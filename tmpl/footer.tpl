...
<footer class="footer mt-auto py-5 bg-light border-top">
    ...
    <a href="/" class="d-inline-flex align-items-center mb-3 text-decoration-none" title="{$settings.site_name}">
        <img src="bitders/assets/logo.svg" alt="{$settings.site_name}" width="40" class="me-3">
        <span class="fs-5 fw-semibold text-dark">{$settings.site_name}</span>
    </a>
    <p class="text-muted small mt-3 mb-0 lh-base">
        Providing reliable investment solutions since <script>document.write(new Date().getFullYear())</script>
    </p>
</div>
    ...
    <div class="row align-items-center gy-3">
        <div class="col-md-6 text-center text-md-start">
            <p class="mb-0 text-muted small">
                &copy; <script>document.write(new Date().getFullYear())</script> {$settings.site_url}. All Rights Reserved.
            </p>
        </div>
